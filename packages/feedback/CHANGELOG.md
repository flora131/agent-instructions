...
- Fixed quoted credential scanning across report boundaries so later headings, feedback sections, and credentials are preserved while valid multiline values remain fully redacted ([#2799](https://github.com/bastani-inc/atomic/issues/2799)).
