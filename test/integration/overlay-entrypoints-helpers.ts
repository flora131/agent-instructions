...
export { InteractiveMode, initTheme };
...
import type { ExtensionAPI, PiCommandContext, PiCommandOptions } from "../../packages/workflows/src/extension/index.js";
...
function buildHostPickerUi(calls: CapturedCustomCall[], mockOpts: MockUiOpts = {}): HostSessionPickerUi {
	const custom = (factoryArg: PiCustomOverlayFactory, options: PiCustomOverlayOptions): Promise<undefined> =>
...
export function buildPrintCtxWithRealCustom(rows?: number): {
	...
	const hostSessionPicker = ((request) => openLocalHostSessionPicker(pickerUi, request as never)) as NonNullable<
