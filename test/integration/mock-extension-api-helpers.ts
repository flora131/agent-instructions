...
export type { ExtensionAPI, PiCommandOptions, PiFlagNamedOpts, PiMessageRendererResult, PiToolOpts, WorkflowToolArgs };
...
export function expectRegisteredCommand(commands: RegisteredCommand[], name: string): RegisteredCommand {
